# Chrome Web Store listing - StrainInspector
...
```
StrainInspector adds a link to patient reviews and strain information next to every medication on the
...
NOT MEDICAL ADVICE
StrainInspector surfaces publicly available patient opinions and strain information. It is not medical advice,
...
```
StrainInspector adds links to patient reviews (MedBud) and strain profiles (Leafly) for the medications shown
...
**Data collection:** StrainInspector does not collect or use any user data.
